...
Moving on to long-term trends, we plotted the amount of calls from Fall 2016 to Spring 2023.


To test this, we plotted the amount of ACEMS cases called to the first-year quad over time.
